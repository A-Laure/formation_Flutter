...
import 'package:todo_app/auth/login_or_register.dart';
import 'package:todo_app/pages/login_page.dart';
import 'package:todo_app/pages/register_page.dart';
import 'package:todo_app/services/todostore.dart';
...
class _HomePageState extends State<HomePage> {
  final TodostoreService todostore = TodostoreService();
    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        actions: [
          ElevatedButton(
            onPressed: () {
              todostore.updateTask(userId,taskId, taskController.text, taskState);
      ...
      body: Container(
        ...
        child: Column(
          ...
          children: [
                  ...
                  Container(
                    ...
                    child: IconButton(
                      onPressed: () {
                        ...
                        todostore.addTask(userId ,taskController.text);
                        taskController.clear();
                      },
                      color: Colors.white,
                      icon: Icon(Icons.add),
            ...
            StreamBuilder(
              stream: todostore.getTodoListByUser(userId),
                        ...
                        return Slidable(
                          ...
                          endActionPane: ActionPane(
                            ...
                            children: [
                              ...
                              SlidableAction(
                                onPressed: (context) =>
                                    todostore.deleteTask(userId,taskId),
